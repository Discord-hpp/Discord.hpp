...
struct Locale
{
	std::string EnglishUS = "en-US";
	std::string EnglishGB = "en-GB";
	std::string Bulgarian = "bg";
	std::string ChineseCN = "zh-CN";
	std::string ChineseTW = "zh-TW";
	std::string Croatian = "hr";
	std::string Czech = "cs";
	std::string Danish = "da";
	std::string Dutch = "nl";
	std::string Finnish = "fi";
	std::string French = "fr";
	std::string German = "de";
	std::string Greek = "el";
	std::string Hindi = "hi";
	std::string Hungarian = "hu";
	std::string Italian = "it";
	std::string Japanese = "ja";
	std::string Korean = "ko";
	std::string Lithuanian = "lt";
	std::string Norwegian = "no";
	std::string Polish = "pl";
	std::string PortugueseBR = "pt-BR";
	std::string Romanian = "ro";
	std::string Russian = "ru";
	std::string SpanishES = "es-ES";
	std::string Swedish = "sv-SE";
	std::string Thai = "th";
	std::string Turkish = "tr";
	std::string Ukrainian = "uk";
	std::string Vietnamese = "vi";
};
